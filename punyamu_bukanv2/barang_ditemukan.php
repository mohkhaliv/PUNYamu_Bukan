...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="lapor.php?type=found" class="btn btn-primary">
    ...
    $stmt = $pdo->query("SELECT * FROM reports WHERE type = 'found' AND status = 'verified' ORDER BY created_at DESC");
    if ($stmt->rowCount() > 0): ?>
        <div class="row">
    ...
    <?php else: ?>
        <div class="text-center py-5">
            <div class="bg-light rounded p-5">
                ...
                <h3>Belum ada laporan barang ditemukan</h3>
                <p class="text-muted">Jadilah yang pertama melaporkan barang temuan Anda.</p>
            </div>
        </div>
    <?php endif; ?>
</div>
